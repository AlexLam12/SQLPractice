...
--INSERT INTO Artist (ArtistName, YearEstablished) VALUES ('Dirty Heads', 2006);
...
--INSERT INTO Album (Title, ReleaseDate, AlbumLength, Label, ArtistId, GenreId) VALUES ('Swim Team', '10/13/2013', 2418, 'FSM', 28, 2);
...
INSERT INTO Song (Title, SongLength, ReleaseDate, GenreId, ArtistId, AlbumId) VALUES ('Mad at It', 197, '10/13/2017', 2, 28, 23);

SELECT a.Title, s.Title FROM Album a LEFT JOIN Song s ON s.AlbumId = a.Id;

SELECT a.Title, s.Title FROM Song s LEFT JOIN Album a ON s.AlbumId = a.Id;

SELECT COUNT(Song.Id) as SongCount, Album.Title from Album
left join Song on Song.AlbumId = Album.Id 
group by Album.Title;

SELECT COUNT(Song.Id) as SongCount, Artist.ArtistName from Artist
left join Song on Song.ArtistId = Artist.Id 
group by Artist.ArtistName;

SELECT COUNT(Song.Id) as SongCount, Genre.Name from Genre
left join Song on Song.GenreId = Genre.Id 
group by Genre.Name;

SELECT COUNT(*) as Labels, Artist.ArtistName from Artist
